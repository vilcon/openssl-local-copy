...
end_of_options:
    ...
    if (req) {
        ...
        if (extfile_conf != NULL) {
            ...
            if (!do_EXT_add_nconf(extfile_conf, &ctx, extensions, NULL,
            ...
            if (extensions != NULL) {
                ...
                X509V3_set_ctx_test(&ctx);
                if (!do_EXT_add_nconf(conf, &ctx, extensions, NULL,
    ...
    if (gencrl) {
        ...
        if (crl_ext != NULL) {
            ...
            X509V3_set_ctx_test(&ctx);
            if (!do_EXT_add_nconf(conf, &ctx, crl_ext, NULL,
 ...
 again2:
    ...
    if (ext_sect) {
        if (extfile_conf != NULL) {
            ...
            if (!do_EXT_add_nconf(extfile_conf, &ext_ctx, ext_sect, ret,
            ...
            if (!do_EXT_add_nconf(lconf, &ext_ctx, ext_sect, ret,

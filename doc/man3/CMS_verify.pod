...
using the supplied trusted certificate store I<store>.
The required purpose is I<smime_sign> unless a different one
has been set in I<store> using L<X509_STORE_set_purpose(3)>.
Any internal certificates in the message
